...
export function ReservationConfirmation({ reservation, table, clientName }: { reservation: CreatedReservation; table: RestaurantTable; clientName: string }) {
    ...
    <Card className="mx-auto max-w-2xl border-[#4b3c1b] bg-[#111] shadow-none">
      <CardContent className="p-6 sm:p-8">
        <div className="text-center">
          ...
          <h2 className="mt-5 text-2xl font-semibold text-white">{t("reservationConfirmed")}</h2>
          <p className="mt-2 text-sm text-gray-500">{t("confirmationSubtitle")}</p>
        </div>
        ...
        <div className="mt-5 rounded-lg border border-[#4b3c1b] bg-[#17140d] p-5 text-center">
          ...
          <p className="mt-2 font-mono text-xl font-semibold tracking-wider text-[#d8b45b]">{reservation.reservationCode}</p>
        </div>
