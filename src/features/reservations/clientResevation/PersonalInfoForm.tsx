...
type Props = {
  ...
  onSuccess: (reservation: CreatedReservation, clientName: string) => void;
};
    ...
    <Card className="mx-auto max-w-3xl border-[#3f3f3f] bg-[#111] shadow-none">
      <CardContent className="p-5 sm:p-7">
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
              ...
              <div className="flex items-center gap-2">
                ...
                <Input
                  ...
                  onChange={(event) => {
                    ...
                    onGuestCountChange(
                      Math.min(table.capacity, Math.max(1, value)),
                    );
                  }}
          ...
          {/* Row 3: Email + Notification Preference */}
